...
return array(
    ...
    */
    ...
    "string"            => ":attribute باید کاراکتر حرف باشد",
    ...
    */
    'attributes' => array(
        ...
        'companyEcoCode' => 'کد اقتصادی شرکت',
        'companyRegisterNumber' => 'شماره ثبت شرکت',
        'companyNationalCode' => 'شناسه ملی شرکت',
        'companyWebSite' => 'آدرس وبسایت شرکت',
        'companyEmail' => 'ایمیل سازمانی',
        'tell' => 'تلفن ثابت',
        'nameFamilyEn' => 'نام و نام خانوادگی لاتین',
        'nameFa' => 'نام فارسی',
        'nameEn' => 'نام انگلیسی',
        'code' => 'کد',
        'tol1' => 'طول ۱',
