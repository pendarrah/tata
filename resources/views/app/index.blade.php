        ...
        <section class="section-custom-medical">
				<div class="container">
					...
					<div class="row mt-5 mb-5 pt-3 pb-3">
						<div class="col-md-8">
							<h2 class="font-weight-semibold mb-0">کمی درباره با تطابق</h2>
							<p class="lead font-weight-normal">تطابق زاییده ی تفرکات چند جوان در یک روز بارانی در مرداد ماه سال 98 در یکی از پارکهای شهر تهران می باشد آنها بهم قول دادند مسیری را ادامه دهند با یک هدف ، "نظم" زیبا ترین کلمه ای که در تمامی فعالیتها مورد نیاز است</p>

							<p>شاید هدف از ساخت تطابق ، در اختیار داشتن یه سیستم مشاوره آنلاین بود و انقدر سازنده های جوانش رو درگیر خود کرد که باور کنن شاید یک چیز مهمتر هم باشد.این یک چیز مهمتر بشدت جرقه بزرگی رو ایجاد کرد برای ایده های جدید ، پیوسته ، بلند مدت و البته مهم تر از همه با ریسک زیاد. هدف ما به حداکثر رساندن سود شرکت ها با عدم وجود اشتباهات رایج در دپارتمان مالی تغییر پیدا کرد. وجه تمایز تطابق با مابقی موسسات خدمات مالی، استفاده از مشاورین حرفه ای، با تجربه، با انگیزه ، مسولیت پذیر و منظبط می باشد . به همین دلیل ما شعارمان به انتظام یک اصل نامیدیم. ما باور داشتیم که تطابق شاید دقیقا همان راه خروجیه همان بنبستی باشد که خیلی از کسب و کارها حتی خودمان نتوانستیم از اون جلوتر بریم. پکیج های مشاوره و مشاوره تضمین شده درون سازمانی در هر کدام از خدمات و در کنار اینها یک سیستم گزارش دهی زنده و منحصر به فرد باعث شد که ما انقدر آیتم های قابل استفاده و با ارزشی رو به تطابق اضافه کنیم تا تبدیل بشه به همون مسیری که ما همیشه بهش نیاز داشتیم. تلاش های بی وقفه تیم مدیران و مشاورین ، تطابق را به این مرحله رساند که بهترین ارائه دهنده خدمات مالی و مالیاتی و انجام دهنده کلیه امور یک سال مالی از پلمپ دفاتر قانونی تا حضور در تمامی مراحل حل اختلاف و مشاوره در امور مالیاتی و حسابرسی تامین اجتماعی در بالاترین سطح کیفیت باشد.

شما میتوانید با استفاده از باشگاه مشاورین ما با تمامی اعضای مشاوره در زمینه های مختلف آشنا شده و برای ارتباط با آنهاست کافیست پس از ثبت نام اشتراک خود را در زمینه ی مربوطه دریافت کنید . 

این آشنایی برای ما ارزشمند است .
ما قدر دان زمانِ شما هستیم ، آیا شما نیز به زمانِ خود اهمیت میدهید ؟</p>

							<a class="btn btn-outline btn-quaternary custom-button text-uppercase mt-4 mb-4 mb-md-0 font-weight-bold"> بیشتر </a>
						</div>
						<div class="col-md-4">
							<img src="/images/gallery-1.jpg" alt="" class="img-fluid box-shadow-custom"> 
						</div>
					</div>
				</div>
			</section>

        <section id="services" class="p-0 bg-light">
            <div class="container">
                <div class="row">
        ...
        <section id="packages" class="bg-light">
            <div class="container">
                <div class="row align-items-center justify-content-center" id="packages-box">
