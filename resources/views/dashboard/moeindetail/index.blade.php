@extends('dashboard.layouts.master', ['title' => 'تکمیل معین ها'])
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">افزودن مثال های جدید </h5>
                ...
                <div class="modal-body modal-scroll" style="background-color:#fbfcfd">
                    <form action="{{ route('moeindetail.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="input-group mt-3">
                                <div class="input-group-prepend min-width-180"><span class="input-group-text bg-light min-width-140" id="basic-addon7"> <i class="fas fa-star required-star mr-1"></i> مثال ها : </span></div>
                                <textarea name="examples" class="form-control"cols="30" rows="10"></textarea>
                            </div>

                            <div class="input-group mt-3">
                                <div class="input-group-prepend min-width-180"><span class="input-group-text bg-light min-width-140" id="basic-addon7"> <i class="fas fa-star required-star mr-1"></i> راه حل ها : </span></div>
                                <textarea name="answers" class="form-control"cols="30" rows="10"></textarea>
                            </div>
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">تکمیل معین ها</span>
            </div>
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                لیست اطلاعات تکمیلی معین ها
                            </h3>
                            <button data-toggle="modal" data-target="#AddBrandModal" style="margin-right: 20px;" type="button" class="btn btn-sm btn-outline-success">افزودن اطلاعات تکمیلی جدید</button>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table style="font-family: iranyekan; width: 100%" class="table table-striped table-bordered table-hover table-checkable display nowrap" id="m_table_2">
                            ...
                            <tr>
                                ...
                                <th title="Field #2" data-field="2">عنوان نکته</th>
                                <th title="Field #2" data-field="2">شماره معین</th>
