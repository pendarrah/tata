@extends('dashboard.layouts.master', ['title' => 'درخواست های تماس'])
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">درخواست های تماس</span>
            </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table style="font-family: iranyekan; width: 100%" class="table table-striped table-bordered table-hover table-checkable display nowrap" id="m_table_2">
                            ...
                            <tr>
                                ...
                                <th title="Field #2" data-field="2">توضیحات</th>
                            ...
                            @foreach($calls as $call)
                                <tr role="row" class="odd icon-hover hover-color">
                                    ...
                                    <td style="direction: rtl; font-family: BYekan!important;">{{ jdate($call->created_at) }}</td>
                                </tr>
                            @endforeach
