@extends('dashboard.layouts.master', ['title' => 'پکیج ها'])
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">افزودن پکیج جدید </h5>
                ...
                <div class="modal-body modal-scroll" style="background-color:#fbfcfd">
                    <form action="{{ route('package.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="input-group mt-3">
                                <div class="input-group-prepend min-width-180"><span class="input-group-text bg-light min-width-140" id="basic-addon7"> <i class="fas fa-star required-star mr-1"></i>قیمت (ریال) :</span></div>
                                <input type="text" class="form-control inputfield" value="{{ old('price') }}" name="price" >
                            </div>

                            <div class="input-group mt-3">
                                <div class="input-group-prepend min-width-180"><span class="input-group-text bg-light min-width-140" id="basic-addon7"> <i class="fas fa-star required-star mr-1"></i>ویژگی ها (با خط فاصله جداشود) :</span></div>
                                <input type="text" class="form-control inputfield" value="{{ old('items') }}" name="items" >
                            </div>
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">مدیریت پکیج ها</span>
            </div>
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <button data-toggle="modal" data-target="#AddBrandModal" style="margin-right: 20px;" type="button" class="btn btn-sm btn-outline-success">افزودن پکیج جدید</button>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table style="font-family: iranyekan; width: 100%" class="table table-striped table-bordered table-hover table-checkable display nowrap" id="m_table_2">
                            ...
                            <tr>
                                ...
                                <th title="Field #2" data-field="2">آیتم ها</th>
                            ...
                            @foreach($packages as $package)
                                <tr role="row" class="odd icon-hover hover-color">
                                    ...
                                    <td>{{ $package->items }}</td>
                                    <td>
                                        <a href="{{ route('package.edit', $package->id) }}" ><i class="far fa-edit text-info mr-1 button font-15"></i></a>
                                        <a href="" id="removePackage" title="حذف" data-name="{{ $package->title }}" data-id="{{ $package->id }}"><i class="far fa-trash-alt text-danger font-15"></i></a>
                                    </td>
                                </tr>
                            @endforeach
