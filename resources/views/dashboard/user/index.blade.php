@extends('dashboard.layouts.master', ['title' => 'مدیریت کاربران'])
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">مدیریت کاربران</span>
            </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table style="font-family: iranyekan; width: 100%" class="table table-striped table-bordered table-hover table-checkable display nowrap" id="m_table_2">
                            ...
                            <tr>
                                ...
                                <th title="Field #2" data-field="2">نام و نام خانوادگی</th>
                                <th title="Field #2" data-field="2">کد ملی</th>
                                <th title="Field #2" data-field="2">شرکت</th>
                                <th title="Field #2" data-field="2">حوزه</th>
                                <th title="Field #2" data-field="2">موبایل</th>
                                <th title="Field #2" data-field="2">ایمیل</th>
                            ...
                            @foreach($users as $user)
                                <tr role="row" class="odd icon-hover hover-color">
                                    ...
                                    <td>{{ $user->email }}</td>
                                    <td>
                                        <a href="{{ route('user.edit', $user->id) }}" ><i class="far fa-edit text-info mr-1 button font-15"></i></a>
                                    </td>
                                </tr>
                            @endforeach
