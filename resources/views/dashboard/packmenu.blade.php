@extends('dashboard.layouts.master', ['title' => 'مدیریت پکیج کاربران'])
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">پکیج کاربران</span>
            </div>
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('moein.index') }}">
                                    <div class="box-menu background-moein">
                                        ساخت معین ها
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="{{ route('moeindetail.index') }}">
                                    <div class="box-menu background-moein-detail">
                                        تکمیل معین ها
                                    </div>
                                </a>
                            </div>
